...
Perpetual is a lightweight Java library for executing collections of dependent processes as a single process.
  ...
  See the Cascading open-source project for an alternative tool for executing Perpetual Annotated classes.
    http://www.cascading.org/

License:

  Perpetual is copyrighted by Concurrent, Inc. (http://www.concurrentinc.com/) and licensed under
...
Developing:
  ...
  Perpetual is currently a Work In Progress and is subject to change in incompatible ways before 1.0.
